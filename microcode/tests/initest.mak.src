...
;
EXTERNAL INITST,ERRTST,ERRINF,ERRINH,ERRINQ
;
;     =======================
...
PSMP2:CONT А=Н2,%TN%
CJS А=INITST,МАР=РЕ
CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0,SHF=LOG
>,ALUS=DZ,FUNC=ADD,Н,ALUD=В,RВ=А
SТРМР2:CJP А=SТРМР2,МАР=РЕ,ALUS=ZА,RА=А,FUNC=EXNOR,Н,ALUD=В,RВ=У,ALU
...
SТРМР3:CJP А=SТРМР3,МАР=РЕ,ALUS=ZА,RА=А,ALU,YDEV=МРМЕМ,WRY,IОМР,MPADR=15
;
;
БОПП4:ENTRY
;===== 4-Й РГ.БОПП - В РГ.А МПС, ОБРАТНЫЙ КОД КОПИРУЕМ В 5-15 РГ.БОПП
;
CJP А=PSMP4,МАР=РЕ
PSMP4:CONT А=Н4,%TN%
CJS А=INITST,МАР=РЕ
...
SТРМР4:CJP А=SТРМР4,МАР=РЕ,ALUS=ZА,RА=У,ALU,YDEV=МРМЕМ,WRY,IОМР,MPADR=15
;
;     ========================
...
CONT А=ERRTST,МАР=РЕ,IСС,%TIK%
CJP А=MPU5,МАР=РЕ,%ТУРЕ%
CJP А=ERRTST,МАР=РЕ
MPU5:CJP А=CMPU5,МАР=РЕ
;
;
БМПУ6:ENTRY
;===== LDCT + RРСТ; INTR = 0-5
...
RPD6:RРСТ А=RPD6,МАР=РЕ,IСС,%TIK%
;INTR=2
...
CJP А=ERRTST,МАР=РЕ
;INTR=4
NЕХТС7:JRP А=CMPU7,МАР=РЕ,%ТУРЕ%
JRP А=ERRTST,МАР=РЕ
;
;
БМПУ8:ENTRY
...
RРСТ А=JS,МАР=РЕ,%TIK%
;1 ЗАГРУЗКА СТЕКА
CJS А=SUBE1,МАР=РЕ
CJP А=CMPU9,МАР=РЕ,%TIK%
...
CJPP А=NС1,МАР=РЕ
NС1:JRP А=ERRTST,МАР=РЕ,IСС,%TIK%
NС2:LDCT А=CMPUA,МАР=РЕ
;INTR=2
...
LDCT А=ERRTST,МАР=РЕ,%TIK%
;INTR=2
JSRP А=SВ2,МАР=РЕ,COND=EMLRG,IСС,%ТУРЕ%
CJP А=ERRTST,МАР=РЕ
SВ1:CRTN
SВ2:CJPP А=CMPUD,МАР=РЕ
;
;
БМПУЕ:ENTRY
...
CJS А=INITST,МАР=РЕ
;1 - В РГ.N
ССТ10:CONT SТОРС=1,CEN,%TIK%
;0 - В N
CONT SТОРС=3,CEN
;ЖДЕМ 1 ТАКТ
LDCT А=ССТ10,МАР=РЕ,SТОРС=20
...
;ЖДЕМ 1 ТАКТ
CONT IСС,SТОРС=21,%TIK%
;П/У НА НАЧАЛО, ЕСЛИ NZ=0 (/NZ=1), ЕСЛИ НЕ 0-Й РЕЗУЛЬТАТ
CJP А=ССТ11,МАР=РЕ,COND=СТ,SТОРС=21
;ОШИБКА; ЧИТАЕМ N В РГ.У
CJS А=ERRINF,МАР=РЕ,SТОРС=1,DDEV=STATUS,ALUS=DZ,ALUD=В,RВ=У
CJP А=ССТ11,МАР=РЕ
;
...
CONT ALUS=ZА,RА=А,FUNC=EXNOR,Н,ALUD=В,RВ=А,CEN
;ЖДЕМ 1 ТАКТ
LDCT А=ССТ12,МАР=РЕ,SТОРС=20
;П/У НА НАЧАЛО, ЕСЛИ NZ=0
JRP А=ERCT12,МАР=РЕ,COND=СТ,SТОРС=20,%TIK%
;ОШИБКА; ЧИТАЕМ N В РГ.У
...
;ЖДЕМ 1 ТАКТ (?)
LDCT А=ССТ13,МАР=РЕ,SТОРС=37,%ТУРЕ%
...
CJS А=INITST,МАР=РЕ
;1 - В РГ.М
ССТ14:CONT SТОРС=1,СЕМ,%TIK%
;0 - В М (MZ=0)
CONT SТОРС=3,СЕМ
;ЖДЕМ 1 ТАКТ
LDCT А=ССТ14,МАР=РЕ,SТОРС=36
...
;ЖДЕМ 1 ТАКТ
LDCT А=ССТ15,МАР=РЕ,SТОРС=36,%TIK%
;П/У НА НАЧАЛО, ЕСЛИ MZ=0; ИЛИ НА ОШИБКУ, ЕСЛИ MZ=1
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=36,DDEV=STATUS,ALUS=DZ,ALUD=В,RВ=У
;
;
...
CONT SТОРС=2,СЕМ,CEN,%TIK%
;ЖДЕМ 1 ТАКТ
CONT SТОРС=21,%ТУРЕ%
;INTR=1; П/У НА ОШИБКУ, ЕСЛИ NZ=0 (/NZ=1)
CJS А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=21,DDEV=STATUS,ALUS=DZ,ALUD=В,RВ=У
;ЖДЕМ 1 ТАКТ
LDCT А=ССТ16,МАР=РЕ,SТОРС=36,%ТУРЕ%
...
ССТ17:CONT ALUS=ZА,RА=А,FUNC=EXNOR,Н,ALUD=В,RВ=А,ALU,SТОРС=0,СЕМ,CEN
>,DDEV=STATUS,WRD
...
LDCT А=ССТ17,МАР=РЕ,SТОРС=21,%TIK%
...
LDCT А=CMPS19,МАР=РЕ,SТОРС=21
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=21,%TIK%
;
;
МПС1А:ENTRY
...
CMPS1A:PUSH А=3,МАР=РЕ,YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56
...
JRP А=CMPS1A,МАР=РЕ,COND=СТ,SТОРС=20,%TIK%
;
;
МПС1В:ENTRY
...
CMPS1C:CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DZ,FUNC=ADD,Н,ALUD=Q
;СНОВА ЧИТАЕМ ИЗ БОПП, СРАВНИВАЕМ С РГ.Q
CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DQ,FUNC=EXOR,Н,ALUD=Q,CEN
LDCT А=CMPS1C,МАР=РЕ,SТОРС=21
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=21,%TIK%
;
;
MПC1D:ENTRY
...
CMPS1D:CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DZ,FUNC=ADD,Н,ALUD=В,RВ=А
...
CJS А=INITST,МАР=РЕ
;СРАВНИВАЕМ
CMPS1E:CONT ALUS=АВ,RА=У,RВ=У,FUNC=EXOR,Н,ALUD=Q,CEN
LDCT А=CMPS1E,МАР=РЕ,SТОРС=21
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=21,%TIK%
;
;
MПC1F:ENTRY
...
LDCT А=CMPS1F,МАР=РЕ,SТОРС=21,%ТУРЕ%
...
LDCT А=CMPS20,МАР=РЕ,SТОРС=21,%ТУРЕ%
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=21
;
;
МПС21:ENTRY
...
CJS А=INITST,МАР=РЕ
;CONST (ЛЮБУЮ) - В WR1
CMPS21:CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DZ,Н,ALUD=В,RВ=WR1
;(.NОТ.R).AND.S
CONT ALUS=АВ,RА=WR1,RВ=WR1,FUNC=NOTRS,Н,ALUD=Q,CEN
LDCT А=CMPS21,МАР=РЕ,SТОРС=21
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=21,%TIK%
;
;
МПС22:ENTRY
...
LDCT А=CMPS22,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
МПС23:ENTRY
;===== ALUS=DQ
...
CJS А=INITST,МАР=РЕ
;CONST - В Q
CMPS23:CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DZ,Н,ALUD=Q
;СРАВНИВАЕМ ЕЕ
CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DQ,FUNC=EXOR,Н,ALUD=В,RВ=У,CEN
LDCT А=CMPS23,МАР=РЕ,SТОРС=21
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=21,%TIK%
;
;
МПС24:ENTRY
...
CJS А=INITST,МАР=РЕ
;CONST - В WR1
CMPS24:CONT YDEV=МРМЕМ,IОМР,MPADR=4,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
>,ALUS=DZ,Н,ALUD=В,RВ=WR1
;ТО ЖЕ - В Q
...
CONT ALUS=ZQ,Н,СЕМ
LDCT А=СН25,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
НМПС26:ENTRY
...
LDCT А=СН26,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
НМПС27:ENTRY
...
LDCT А=СН27,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
НМПС28:ENTRY
...
;INTR=2; ПРОВЕРЯЕМ СТ.РАЗРЯДЫ WR1 (Д.Б.=0)
CONT ALUS=AQ,RА=WR1,FUNC=AND,Н,СЕМ
LDCT А=СН28,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
НМПС29:ENTRY
...
LDCT А=СН29,МАР=РЕ,SТОРС=37,%ТУРЕ%
JRP А=ERRINF,МАР=РЕ,COND=СТ,SТОРС=37,%TIK%
;
;
;     ========================
...
;ДЕЛАЕМ CONST FF
CMPS2A:CONT ALUS=DZ,FUNC=AND,Н,ALUD=В,RВ=У
...
CMPS2B:CONT ALUS=DZ,FUNC=AND,Н,ALUD=В,RВ=У
CONT ALUS=ZВ,RВ=У,FUNC=EXNOR,Н,ALUD=В
CONT ALUS=DZ,Н,ALUD=ВА,RА=У,RВ=А,ALU,DSRC=SHIFT,MPS,PSHF=SН0-56,SHF=LOG
CONT ALUS=DZ,Н,ALUD=ВА,RА=А,RВ=У,ALU,DSRC=SHIFT,MPS,PSHF=SН0+56,SHF=LOG
...
CONT SТОРС=/NZ
CJS А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=/NZ,%TIK%
CJP А=CMPS2B,МАР=РЕ
;
;
МПС2С:ENTRY
...
CJS А=INITST,МАР=РЕ
;0 - В РГ.У
CMPS2C:CONT ALUS=DZ,FUNC=AND,Н,ALUD=В,RВ=У
PUSH А=30,МАР=РЕ
;УВЕЛИЧИВАЕМ РГ.У
...
CJS А=ERRINQ,МАР=РЕ,COND=СТ,SТОРС=48,%TIK%
CJP А=CMPS2C,МАР=РЕ
;
;
;       ==================================
...
CJP А=CTG30,МАР=РЕ,FFCNT=SETTR1
;
;
ТГ31:ENTRY
